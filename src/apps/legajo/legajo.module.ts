...
class Legajo {
  ...
  cargarTablaAeuLegajos(zonas: string) {
   ...
   /* console.log(this.ccdd);
    ...
    console.log(this.ccdi);*/
    this.zona = zonas; //
   /* console.log(zonas);
    console.log(ubigeo);*/
    if (this.ccdi!= 0) {

      this.reportes.getTabAeusLeg(ubigeo, zonas).subscribe(res => {
    ...
    // if (this.ccdi != 0) {
    //   this.reportes.getTabAeusLeg(ubigeo, zona).subscribe(res => {
    //     this.num_pag = <ZonaInterface>res;
    //     console.log(this.datapaginaspdf);
    //   })
    //   //this.cargarTabla("3", this.ccdd, this.ccpp, this.ccdi, "0")
