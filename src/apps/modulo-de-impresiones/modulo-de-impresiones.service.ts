...
export class ImpresionesService {
    ...
    getImpresion(ubigeo: string = '0', zona: string= '0', nombre: Object, opc: string='0'): Observable < Object > {


        let headers = new Headers({ 'Content-Type': 'application/json' });
        let options = new RequestOptions({ headers: headers });
        let body = JSON.stringify({ubigeo: ubigeo, zona: zona, nombre: nombre, opc: opc});
